...
public class Transporters {
    ...
    public static Client connect(String url, ChannelEventHandler... handler) throws RemotingException {
        return connect(NetURL.valueOf(url), handler);
    }

    public static Client connect(NetURL url, ChannelEventHandler... handlers) throws RemotingException {
        if (url == null) {
            throw new IllegalArgumentException("url == null");
        }
        ChannelEventHandler handler;
