...
public abstract class ByteToMessageDecoder extends ChannelInboundHandlerAdapter {
   ...
   * Object)} call. This may be useful if you need to do some protocol upgrade and want to make sure
   * nothing is mixed up.
   * <p>
  ...
  /**
   * If {@code true} then only one message is decoded on each {@link #channelRead(ChannelHandlerContext,
   * Object)} call.
   * <p>
   * Default is {@code false} as this has performance impacts.
   */
   ...
   * internal buffer directly to write a decoder. Use it only when you must use it at your own
   * risk.
   */
  ...
  /**
   * Called when the input of the channel was closed which may be because it changed to inactive or
   * because of {@link ChannelInputShutdownEvent}.
   */
