...
/**
 * {@link ChannelOutboundHandlerAdapter} which encodes message in a stream-like fashion from one
 * message to an {@link ByteBuf}.
 * <p>
 * <p>
...
public abstract class MessageToByteEncoder<I> extends ChannelOutboundHandlerAdapter {
   ...
   *                     target for the encoded messages. If {@code false} is used it will allocate
   ...
   * @param preferDirect        {@code true} if a direct {@link ByteBuf} should be tried to be used
   *                            as target for the encoded messages. If {@code false} is used it will
  ...
  /**
   * Allocate a {@link ByteBuf} which will be used as argument of {@link
   * #encode(ChannelHandlerContext, I, ByteBuf)}. Sub-classes may override this method to return
   * {@link ByteBuf} with a perfect matching {@code initialCapacity}.
   */
