...
public class Exchangers {
    ...
    public static ExchangeServer bind(String url, ChannelEventHandler handler, Replier<?> replier) throws RemotingException {
        return bind(NetURL.valueOf(url), handler, replier);
    }

    public static ExchangeServer bind(NetURL url, ChannelEventHandler handler, Replier<?> replier) throws RemotingException {
    ...
    public static ExchangeClient connect(String url, ChannelEventHandler handler, Replier<?> replier) throws RemotingException {
        return connect(NetURL.valueOf(url), handler, replier);
    }

    public static ExchangeClient connect(NetURL url, ChannelEventHandler handler, Replier<?> replier) throws RemotingException {
    ...
    public static ExchangeClient connect(NetURL url, ExchangeHandler handler) throws RemotingException {
        if (url == null) {
            throw new IllegalArgumentException("url == null");
        }
        if (handler == null) {
