...
public final class URLBuilder {
  ...
  public URLBuilder(String protocol, String username, String password, String host, int port,
  ...
  public static URLBuilder from(NetURL url) {
  ...
  public URLBuilder addParameterAndEncoded(String key, String value) {
    ...
    return addParameter(key, NetURL.encode(value));
  }
