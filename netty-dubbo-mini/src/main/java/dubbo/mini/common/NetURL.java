...
//    }
    ...
    public NetURL(String protocol, String host, int port, String path, Map<String, String> parameters) {
    ...
    public static NetURL valueOf(NetURL url, String[] reserveParams, String[] reserveParamPrefixs) {
        ...
        return newMap.isEmpty() ? new NetURL(url.getProtocol(), url.getHost(), url.getPort(), url.getPath(), null)
