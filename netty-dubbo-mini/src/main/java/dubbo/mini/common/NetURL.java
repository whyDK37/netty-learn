...
public class NetURL implements Serializable {
  ...
  private volatile transient Map<String, NetURL> urls;
...
//    }
  ...
  public NetURL(String protocol, String host, int port, String path,
   ...
   * @see NetURL
   */
  public static NetURL valueOf(String url) {
    ...
    return new NetURL(protocol, host, port, path, parameters);
  }

  public static NetURL valueOf(String url, String... reserveParams) {
    NetURL result = valueOf(url);
  ...
  public static NetURL valueOf(NetURL url, String[] reserveParams, String[] reserveParamPrefixs) {
    ...
    if (reserveParamPrefixs != null && reserveParamPrefixs.length != 0) {
      for (Map.Entry<String, String> entry : oldMap.entrySet()) {
        for (String reserveParamPrefix : reserveParamPrefixs) {
          if (entry.getKey().startsWith(reserveParamPrefix) && !StringUtils
    ...
    return newMap.isEmpty() ? new NetURL(url.getProtocol(), url.getHost(), url.getPort(),
        url.getPath(), null)
        : new NetURL(url.getProtocol(), url.getHost(), url.getPort(), url.getPath(), newMap);
  }
  ...
  public NetURL setProtocol(String protocol) {
    return new NetURL(protocol, host, port, path, getParameters());
  }
   ...
   * <p>
   * Pls. note that IP should be used instead of Host when to compare with socket's address or to
   * search in a map which use address as its key.
   *
  ...
  public NetURL setAddress(String address) {
  ...
  public NetURL setPath(String path) {
    return new NetURL(protocol, host, port, path, getParameters());
  }
  ...
  private Map<String, NetURL> getUrls() {
  ...
  public NetURL getUrlParameter(String key) {
    NetURL u = getUrls().get(key);
    if (u != null) {
      return u;
    }
  ...
  public String getMethodParameterAndDecoded(String method, String key) {
    return NetURL.decode(getMethodParameter(method, key));
  }

  public String getMethodParameterAndDecoded(String method, String key, String defaultValue) {
    return NetURL.decode(getMethodParameter(method, key, defaultValue));
  }
  ...
  public NetURL addParameterAndEncoded(String key, String value) {
    if (StringUtils.isEmpty(value)) {
      return this;
    }
  ...
  public NetURL addParameter(String key, boolean value) {
    return addParameter(key, String.valueOf(value));
  }

  public NetURL addParameter(String key, char value) {
    return addParameter(key, String.valueOf(value));
  }

  public NetURL addParameter(String key, byte value) {
    return addParameter(key, String.valueOf(value));
  }

  public NetURL addParameter(String key, short value) {
    return addParameter(key, String.valueOf(value));
  }

  public NetURL addParameter(String key, int value) {
    return addParameter(key, String.valueOf(value));
  }

  public NetURL addParameter(String key, long value) {
    return addParameter(key, String.valueOf(value));
  }

  public NetURL addParameter(String key, float value) {
    return addParameter(key, String.valueOf(value));
  }

  public NetURL addParameter(String key, double value) {
    return addParameter(key, String.valueOf(value));
  }

  public NetURL addParameter(String key, Enum<?> value) {
    if (value == null) {
      return this;
    }
    return addParameter(key, String.valueOf(value));
  ...
  public NetURL addParameter(String key, Number value) {
    if (value == null) {
      return this;
    }
    return addParameter(key, String.valueOf(value));
  ...
  public NetURL addParameter(String key, CharSequence value) {
    if (value == null || value.length() == 0) {
      return this;
    }
    return addParameter(key, String.valueOf(value));
  ...
  public NetURL addParameter(String key, String value) {
    ...
    map.put(key, value);
    return new NetURL(protocol, host, port, path, map);
  }

  public NetURL addParameterIfAbsent(String key, String value) {
    if (StringUtils.isEmpty(key)
        || StringUtils.isEmpty(value)) {
      return this;
    }
   ...
   * @return A new URL
   */
  public NetURL addParameters(Map<String, String> parameters) {
  ...
  public NetURL addParametersIfAbsent(Map<String, String> parameters) {
    if (CollectionUtils.isEmptyMap(parameters)) {
      return this;
    }
  ...
  public NetURL addParameters(String... pairs) {
  ...
  public NetURL addParameterString(String query) {
  ...
  public NetURL removeParameter(String key) {
    if (StringUtils.isEmpty(key)) {
      return this;
    }
  ...
  public NetURL removeParameters(Collection<String> keys) {
  ...
  public NetURL removeParameters(String... keys) {
  ...
  public NetURL clearParameters() {
    return new NetURL(protocol, host, port, path, new HashMap<>());
  }
...
//        }
  ...
  public String getPathKey() {
    String inf = !StringUtils.isEmpty(path) ? path : getServiceInterface();
    if (inf == null) {
      return null;
    }
    return buildKey(inf);
  ...
  public NetURL setServiceInterface(String service) {
