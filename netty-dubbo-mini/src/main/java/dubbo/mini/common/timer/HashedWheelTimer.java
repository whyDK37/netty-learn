...
public class HashedWheelTimer implements Timer {
   ...
   * Creates a new timer.
   *
   * @param threadFactory      a {@link ThreadFactory} that creates a background {@link Thread}
   ...
   *                           newTimeout} will result in {@link java.util.concurrent.RejectedExecutionException}
   *                           being thrown. No maximum pending timeouts limit is assumed if this
