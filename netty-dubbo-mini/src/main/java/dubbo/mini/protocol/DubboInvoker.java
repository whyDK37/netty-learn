...
import dubbo.mini.common.utils.ConfigurationUtils;
...
public class DubboInvoker<T> extends AbstractInvoker<T> {
    ...
    public DubboInvoker(Class<T> serviceType, NetURL url, ExchangeClient[] clients) {
        this(serviceType, url, clients, null);
    }

    public DubboInvoker(Class<T> serviceType, NetURL url, ExchangeClient[] clients, Set<Invoker<?>> invokers) {
