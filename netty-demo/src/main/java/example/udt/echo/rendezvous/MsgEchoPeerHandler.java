...
/**
 * Handler implementation for the echo peer. It initiates the ping-pong traffic between the echo
 * peers by sending the first message to the other peer on activation.
 */
