...
public class OcspRequestBuilder {
  ...
  /**
   * ATTENTION: The returned {@link OCSPReq} is not re-usable/cacheable! It contains a one-time
   * nonce and CA's will (should) reject subsequent requests that have the same nonce value.
   */
