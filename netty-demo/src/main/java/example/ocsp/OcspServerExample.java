...
/**
 * ATTENTION: This is an incomplete example! In order to provide a fully functional end-to-end
 * example we'd need an X.509 certificate and the matching PrivateKey.
 */
...
public class OcspServerExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    X509Certificate[] keyCertChain = parseCertificates(OcspServerExample.class,
        "netty_io_chain.pem");
  ...
  private static ChannelInitializer<Channel> newServerHandler(
