...
import example.sctp.SctpEchoClientHandler;
...
public final class SctpMultiHomingEchoClient {
  ...
  private static final String CLIENT_SECONDARY_HOST = System
      .getProperty("host.secondary", "127.0.0.2");
  ...
  private static final int SERVER_REMOTE_PORT = Integer
      .parseInt(System.getProperty("port.remote", "8007"));
...
//                             new LoggingHandler(LogLevel.INFO),
      ...
      InetSocketAddress remoteAddress = SocketUtils
          .socketAddress(SERVER_REMOTE_HOST, SERVER_REMOTE_PORT);
