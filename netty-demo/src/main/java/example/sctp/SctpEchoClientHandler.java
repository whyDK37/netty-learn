...
/**
 * Handler implementation for the SCTP echo client.  It initiates the ping-pong traffic between the
 * echo client and server by sending the first message to the server.
 */
